<div class="text-center">
	...
	<div class="mb-5 mt-5">
		...
		<div class="clearfix">
			...
			<input id="api-copy-input" type="text" style="position:absolute; top: -9999px; z-index: -9;" value="https://www.uuidtools.com/api/generate/timestamp-first/count/1">
...
<script>
	...
	function refresh_uuid() {
		$.ajax({
			url: "/api/generate/timestamp-first",
